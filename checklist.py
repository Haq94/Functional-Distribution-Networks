...
# Define the checklist content in Markdown
checklist_md = """# ✅ FDN Paper Submission Checklist — *ICLR 2026*
...
# Save the Markdown checklist
output_path = Path("FDN_ICLR2026_Checklist.md")
output_path.write_text(checklist_md, encoding='utf-8')

output_path.name  # Return just the file name to confirm creation
